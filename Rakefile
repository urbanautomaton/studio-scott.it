...
UNCOMMITTED_CHANGES = "Uncommitted changes exist in the source repo - please commit, stash or discard."
...
task(:deploy) do
  # raise RuntimeError, UNCOMMITTED_CHANGES if uncommitted_changes?
